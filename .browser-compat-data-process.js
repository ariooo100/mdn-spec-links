...
const fixCanIUseSpecURLs = (key, data) => {
  if (data && data instanceof Object && 'spec' in data) {
    ...
    specURL = specURL
      .replace('w3.org/TR/css3-fonts/#font-rend-props', 'drafts.csswg.org/css-fonts-3/#font-rend-props')
      ...
      .replace('css-contain-1/#contain-property', 'css-contain-2/#contain-property')
